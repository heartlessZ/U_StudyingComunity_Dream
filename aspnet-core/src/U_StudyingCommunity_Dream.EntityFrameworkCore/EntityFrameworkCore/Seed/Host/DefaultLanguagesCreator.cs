...
namespace U_StudyingCommunity_Dream.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = U_StudyingCommunity_DreamConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(U_StudyingCommunity_DreamDbContext context)
        {
            _context = context;
        }
